...
public final class ConstructorBuilder10<In, A, B, C, D, E, F, G, H, I, J, Out>
     ...
     */
    @Override
    public ConstructorBuilder9<In, B, C, D, E, F, G, H, I, J, Out> bind(Function<? super In, ? extends A> getter) {
    ...
    private Fn10<In, B, C, D, E, F, G, H, I, J, Out> applyGetter(Function<? super In, ? extends A> getter) {
