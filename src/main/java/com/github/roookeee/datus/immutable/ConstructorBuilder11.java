...
public final class ConstructorBuilder11<In, A, B, C, D, E, F, G, H, I, J, K, Out>
     ...
     */
    @Override
    public ConstructorBuilder10<In, B, C, D, E, F, G, H, I, J, K, Out> bind(Function<? super In, ? extends A> getter) {
    ...
    private Fn11<In, B, C, D, E, F, G, H, I, J, K, Out> applyGetter(Function<? super In, ? extends A> getter) {
