...
public final class ConstructorBuilder6<In, A, B, C, D, E, F, Out>
     ...
     */
    @Override
    public ConstructorBuilder5<In, B, C, D, E, F, Out> bind(Function<? super In, ? extends A> getter) {
    ...
    private Fn6<In, B, C, D, E, F, Out> applyGetter(Function<? super In, ? extends A> getter) {
